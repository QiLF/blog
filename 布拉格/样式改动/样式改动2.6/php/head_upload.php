...
else
{
    ...
    {
        //防止文件名重复
        $searchname ="img/".$username.".".substr($_FILES["file"]["type"],6);
        $filename ="../img/".$username.".".substr($_FILES["file"]["type"],6);
        //转码，把utf-8转成gb2312,返回转换后的字符串， 或者在失败时返回 FALSE。
        $searchname=iconv("UTF-8","gb2312",$searchname);
        ...
        if($num)
	    {
		    mysqli_query($con,"UPDATE avatar SET avatarname = '$searchname' WHERE username = '$username'");  
	    }
	    else
	    {
