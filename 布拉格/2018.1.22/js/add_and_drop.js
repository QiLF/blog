				...
				<div class="layui-col-sm1"></div>\
		                <div class="layui-col-sm5">\
		                  ...
		                  <div class="layui-input-block">\
		                    <input name="submission'+flag+'" class="layui-input" type="text" placeholder="请输入子项目" autocomplete="off" lay-verify="required">\
		                  </div>\
		                </div>\
		                <div class="layui-col-sm5">\
		                  <label class="layui-form-label">执行者</label>\
		                  <div class="layui-input-block">\
		                   <input name="worker'+flag+'" class="layui-input" type="text" placeholder="请输入执行者" autocomplete="off" lay-verify="required">\
		                  </div>\
		                </div>\
		                <div class="layui-col-sm1"></div>\
		          </div>';
