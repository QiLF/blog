...
function add_one_history_task(task_label)
{
	...
	var content= "<div style='position:relative;float:none'>"
				+	"<div class='layui-text' ><span style='color:black'>任务名称:</span>"+history_tasks[task_label-1].name+"</div>"
				...
				+		"<div class='layui-timeline-title' ><span style='color:black'>任务简介:</span>"+history_tasks[task_label-1].introduction+"</div>"
				+		"<div class='layui-timeline-title' ><span style='color:black'>开始日期:</span>"+history_tasks[task_label-1].start_date+"  <span style='color:black'>截止日期:</span>"+history_tasks[task_label-1].end_date+"</div>"
				+		"<div class='layui-timeline-title' ><span style='color:black'>优先级:</span>"+priority[history_tasks[task_label-1].priority-1]+"</div>"
				+		"<div class='layui-timeline-title' >"
				+       	"<i class='layui-icon' style='font-size: 30px; color: #FF5722;'>&#xe756;</i>"
				+			"<span style='color:black'>参与成员：</span>"+history_tasks[task_label-1].members
				+		"</div>"
				+ 	"</div>"
...
function add_one_sub_task_h(task_label,sub_task_label)
{
	...
	$("#"+task_list_id).append(
										"<li class='layui-timeline-item'>"
											...
											+		"<span style='color:black'>子项名称：</span>"+history_tasks[task_label-1].subtasks[sub_task_label-1].name
											+		"<span id='"+face_id+"'></span>"
											+	"</div>"
											+	"<div id='"+sub_task_content_id+"' style='display:none'>"
											+		"<div class='layui-timeline-title' ><span style='color:black'>开始时间：</span>"+history_tasks[task_label-1].subtasks[sub_task_label-1].start_date+ "</div>"
											+		"<div class='layui-timeline-title' ><span style='color:black'>截止时间：</span>"+history_tasks[task_label-1].subtasks[sub_task_label-1].end_date+ "</div>"
											+		"<div class='layui-timeline-title' ><span style='color:black'>完成时间：</span>"+real_end_time+ "</div>"
											+		"<div class='layui-timeline-title'><span style='color:black'>负责人：</span>"+history_tasks[task_label-1].subtasks[sub_task_label-1].members+"</div>"
											+		"<div class='layui-timeline-title'><span style='color:black'>评价：</span>"+evaluation+"</div>"
											+	"</div>"
											+"</div>"
										+"</li>"
	 						   );
